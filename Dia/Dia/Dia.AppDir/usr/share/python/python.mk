...
# include ././/share/python/python.mk
#
...
#   py_libdir = ././/lib/python$(subst python,,$(1))/site-packages
...
py_libdir = ././/lib/python$(strip $(if $(findstring 3.,$(subst python,,$(1))),3,$(subst python,,$(1))))/$(py_sitename)
